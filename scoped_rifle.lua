...
Tools[21].Grip = CFrame.new(-5, -3.8, -0.2) * CFrame.Angles(0, math.rad(-90), 0)
Tools[21].Parent = plr.Character

Tools[22].Grip = CFrame.new(-2, -3.8, -0.2) * CFrame.Angles(0, math.rad(-90), 0)
Tools[22].Parent = plr.Character

Tools[23].Grip = CFrame.new(0, -3.8, -0.2) * CFrame.Angles(0, math.rad(-90), 0)
Tools[23].Parent = plr.Character

Tools[24].Grip = CFrame.new(-7, -3.8, -0.2) * CFrame.Angles(0, math.rad(-90), 0)
Tools[24].Parent = plr.Character

Tools[25].Grip = CFrame.new(-9, -3.8, -0.2) * CFrame.Angles(0, math.rad(-90), 0)
Tools[25].Parent = plr.Character

Tools[25].Grip = CFrame.new(-3, -4.3, -0.2) * CFrame.Angles(0, math.rad(-90), 0)
Tools[25].Parent = plr.Character


Tools[26].Grip = CFrame.new(-4, -4.3, -0.2) * CFrame.Angles(0, math.rad(-90), 0)
